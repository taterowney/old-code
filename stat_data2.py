...
#		self.data_types=data_types
		...
		if type(self.data)==list:
			self.data=self._make_freq_table(self.data)
...
#		return 99
	...
	def range(self):
		return min(self),max(self),max(self)-min(self)+1
...
#	set2.all_stats()
#	correlation_coefficient(set1,set2)
	print(set1.get_percentile(20))
	print(set1.get_percentile(21))
